...
const provider = new providers.JsonRpcProvider(
    'https://eth-mainnet.g.alchemy.com/v2/oMcNKUDT31W1-oj5d_sqCTezH-SGn-xe'
)
const wsProvider = new providers.WebSocketProvider(
    'wss://eth-mainnet.g.alchemy.com/v2/oMcNKUDT31W1-oj5d_sqCTezH-SGn-xe'
)

// 3. The unique ID for flashbots to identify you and build trust over time
const authSigner = new Wallet(
    'a669630e1db34a63d7478c92f2ccfea6251cfa876553eb21de1332262658e57a',
    provider
)
